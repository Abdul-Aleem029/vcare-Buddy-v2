...
export interface IChatTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IChatTabRemoveProps {

}

/**
 * Implementation of Chat remove page
 */
export class ChatTabRemove  extends TeamsBaseComponent<IChatTabRemoveProps, IChatTabRemoveState> {
